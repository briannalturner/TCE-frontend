        ...
        return (
            <div>
                ...
                <div class="row mx-3 mb-4">
                    <div class="col-md card-grow rounded mx-1 py-2 blue-background clickable" onClick={() => window.location = "/about"}>
                        <h3 class="display-4">The Turner Concrete Philosophy</h3>
                        <p>
                        Get to know us as a company.
                        </p>
                    </div>
                    <div class="col-md card-grow rounded mx-1 py-2 blue-background clickable" onClick={() => window.location = "/reviews"}>
                        <h3 class="display-4">What Our Customers Have To Say</h3>
                        <p>
                        Find out what it's like to hire us.
                        </p>
                    </div>
                    <div class="col-md card-grow rounded mx-1 py-2 blue-background clickable" onClick={() => window.location = "/careers"}>
